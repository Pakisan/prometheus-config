...
/**
 * Describes Prometheus lightsail_sd_config.
 *
 * @since  1.0.0
...
@NoArgsConstructor
@AllArgsConstructor
public class LightsailSdConfig {
    ...
    /**
     * The AWS API keys. If blank, the environment variables `AWS_ACCESS_KEY_ID` is used.
     */
    private String access_key;

    /**
     * The AWS API keys. If blank, the environment variables `AWS_SECRET_ACCESS_KEY` is used.
     */

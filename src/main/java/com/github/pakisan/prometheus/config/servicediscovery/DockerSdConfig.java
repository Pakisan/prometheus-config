...
/**
 * Describes Prometheus docker_sd_config.
 *
 * @since  1.0.0
...
public class DockerSdConfig {
     ...
     */
    private String host_networking_host = "localhost";
     ...
     * resources.
     *
     * @see <a href="https://docs.docker.com/engine/api/v1.40/#operation/ContainerList">The available filters are listed in the upstream documentation</a>
     */
